...
gallery.addEventListener("click", handleCardClick) 
 ...
 function handleCardClick(event) {
    ...
    console.log("Посилання на зображення:", originalImageSrc);
 ...
 const instance = basicLightbox.create(`
    ...
    //   додав цей код тому що при натисканні на <a> відкривався файловий провідник
      const link = event.target.closest(".gallery-link");
      if (link && event.target.nodeName !== "IMG") {
        event.preventDefault();
        console.log("Клік по посиланню");
      }
